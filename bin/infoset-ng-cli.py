...
class _Build(object):
    """Class processes CLI 'build' option."""
...
""")
        ...
        for _main, data_dict in directory_dict.items():
            if _main != 'main':
                ...
                log.log2die_safe(1000, log_message)
    ...
    def write(self):
        ...
        with open(filepath, 'w') as outfile:
            ...
            # Write status Update
            _ok('Created configuration file {}.'.format(filepath))
...
class _PreCheck(object):
    ...
    def _memcached(self):
        ...
        if bool(response['error_code']) is True:
            ...
            log.log2see_safe(1000, log_message)
        else:
    ...
    def _pip(self):
        ...
        if bool(response['error_code']) is True:
            ...
            modules = ['setuptools', 'PyYAML', 'PyMySQL']
