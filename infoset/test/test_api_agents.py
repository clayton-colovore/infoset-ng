...
class APITestCase(unittest.TestCase):
    ...
    def test_agents(self):
        ...
        self.assertEqual(result['id_agent'], self.good_agent.id_agent())
        self.assertEqual(result['exists'], self.good_agent.exists())
        self.assertEqual(result['enabled'], self.good_agent.enabled())
        self.assertEqual(result['idx_agent'], self.good_agent.idx_agent())
        self.assertEqual(
            result['idx_agentname'], self.good_agent.idx_agentname())
        self.assertEqual(result['agent'], self.good_agent.agent())
